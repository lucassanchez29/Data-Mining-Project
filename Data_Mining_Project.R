...
mvp <- read.csv('https://storage.googleapis.com/kagglesdsdata/datasets/587171/1059362/mvpsb.csv?X-Goog-Algorithm=GOOG4-RSA-SHA256&X-Goog-Credential=gcp-kaggle-com%40kaggle-161607.iam.gserviceaccount.com%2F20241212%2Fauto%2Fstorage%2Fgoog4_request&X-Goog-Date=20241212T041459Z&X-Goog-Expires=259200&X-Goog-SignedHeaders=host&X-Goog-Signature=')
...
SB <- read.csv("~/Desktop/SB4xlsx.csv")
SB$date <- as.Date(SB$date)
...
#7 
ggplot(SB, aes(x = reorder(Name, -Win_Count), y = Win_Count, fill = Conference)) +
  geom_bar(stat = "identity") +
  labs(title = "Super Bowl Wins by NFL Team and Conference", x = "NFL Team", y = "Number of Wins") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
...
division_wins <- SB %>%
  group_by(Division) %>%
  summarise(total_wins = sum(Win_Count, na.rm = TRUE)) %>%
  ungroup()
